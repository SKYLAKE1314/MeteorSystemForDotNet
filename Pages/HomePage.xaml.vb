...
Partial Class HomePage
    ...
    Private Const VoicePromptMatchCompleteScan As String = "MatchCompletedPleaseScan.wav"   ' 匹配完成，請刷碼
    Private Const VoicePromptDecodeCompleteOcr As String = "DecodeCompletedPleaseOCR.wav"    ' 解碼完成，請OCR識別
    Private Const VoicePromptSingleFlowCompleted As String = "SingleFlowCompleted.wav"       ' 單次流程完成
    ...
    ''' <summary>
    ''' 播報告警（找不到模板等情況）。可從外部 (ProcessPage) 呼叫。
    ''' </summary>
